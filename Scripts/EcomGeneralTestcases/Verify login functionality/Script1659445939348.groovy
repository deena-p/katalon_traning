...
CustomKeywords.'basic.GeneralAppLibrary.startAndLoginToApp'(GlobalVariable.userName, GlobalVariable.password)
...
CustomKeywords.'basic.GeneralAppLibrary.startAndLoginToApp'(GlobalVariable.userName, "wrongpassword")
